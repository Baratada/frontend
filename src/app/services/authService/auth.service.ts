...
export class AuthService {
  ...
  register(username: string, password: string, email: string, birth_date: Date): Observable<any> {
    return this.http.post(`${this.apiUrl}/register`, { username, password, email, birth_date });
  }
